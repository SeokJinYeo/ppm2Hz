...
function b0 = ppm2Hznl_KD(chi,dr,ff,bf,n,l,B0)
if nargin < 7
    B0 = 3;
 if nargin < 6
     l = [0 0 1];
...
kernel = n1*l1*f1(KX_SQ,KY_SQ,KZ_SQ)+n2*l2*f1(KY_SQ,KX_SQ,KZ_SQ)+n3*l3*f1(KZ_SQ,KY_SQ,KX_SQ)+...
    (n2*l1+n1*l2)*f2(KX_SQ,KY_SQ,KZ_SQ)+(n3*l1+n1*l3)*f2(KX_SQ,KZ_SQ,KY_SQ)+...
    (n3*l2+n2*l3)*f2(KZ_SQ,KY_SQ,KX_SQ);
