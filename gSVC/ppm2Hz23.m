function [b0,S,T] = ppm2Hz23(chi,dr,r,t)
...
K = asinh(X2./sqrt(Z2.^2+Y2.^2))+asinh(X2./sqrt(Z1.^2+Y1.^2))+...
    asinh(X1./sqrt(Z1.^2+Y2.^2))+asinh(X1./sqrt(Z2.^2+Y1.^2))-...
    asinh(X2./sqrt(Z2.^2+Y1.^2))-asinh(X2./sqrt(Z1.^2+Y2.^2))-...
    asinh(X1./sqrt(Z2.^2+Y2.^2))-asinh(X1./sqrt(Z1.^2+Y1.^2));  % Y-Z
