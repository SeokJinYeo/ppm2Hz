...
Z1 = Z-dz/2;
Z2 = Z+dz/2;
K = n1*l1.*atan1(Z1,Y1,X1,Z2,Y2,X2)+n2*l2.*atan1(X1,Z1,Y1,X2,Z2,Y2)+n3*l3.*atan1(X1,Y1,Z1,X2,Y2,Z2)+...
    (n2*l1+n1*l2).*sinh1(X1,Y1,Z1,X2,Y2,Z2)+(n3*l1+n1*l3).*sinh1(X1,Z1,Y1,X2,Z2,Y2)+...
    (n3*l2+n2*l3).*sinh1(Z1,Y1,X1,Z2,Y2,X2);
